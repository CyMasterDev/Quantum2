...
// Serve the Vite built static files (CSS, JS, etc.)
app.use(express.static(viteDistPath));

// Serve other static assets if needed (e.g., your public assets)
app.use(express.static(path.join(__dirname, 'public')));

// Serve epoxy, UV, libcurl, and baremux paths
...
// Always serve index.html for SPA routing (React Router handling)
app.get('*', (req, res) => {
...
server.on('listening', () => {
	...
	console.log(
		chalk.bold(
			theme(`
wow it actually worked no wayyy
`)
		)
	);
	console.log(
